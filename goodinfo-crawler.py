...
def goodinfo(stock_code):
    ...
    try:
        ...
        # 判斷使用者輸入為何 #############################################################################################################################
        stock = is_chinese_or_digit(stock_code)
        ...
        # 將需要顯示的資訊放入一個字典
        display_info = {
            "股票代號": financial_dict['stock_id'],
            "股票名稱": financial_dict['stock_name'],
            "資本額": financial_dict['capital'],
            "產業": financial_dict['industry'],
            "公司業務": financial_dict.get('major business', 'N/A')  # 使用 get 方法防止找不到鍵的錯誤
        }
        return financial_dict, display_info
